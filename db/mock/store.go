...
// ListTranfer mocks base method.
func (m *MockStore) ListTranfer(arg0 context.Context, arg1 db.ListTranferParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListTranfer", arg0, arg1)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListTranfer indicates an expected call of ListTranfer.
func (mr *MockStoreMockRecorder) ListTranfer(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListTranfer", reflect.TypeOf((*MockStore)(nil).ListTranfer), arg0, arg1)
}
